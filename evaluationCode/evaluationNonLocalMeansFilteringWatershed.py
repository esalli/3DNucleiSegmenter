# ============================================================
# Evaluation of patch based filtering +  
...
if saveResultsToFile==True:
 f=open(c.EVALUATION_SCORES_DATADIR+'completeresults_expanded_nonlocalmeansfilteringwatershed.txt', 'a') 
else: 
  f=sys.stdout
...
if 1==1:
 ...
 for sph in c.SPHEROIDS:
  ...
  print("*********************************************************")
  filelist=        glob.glob(c.PREPROCESSED_SPHEROIDS_FILTERED_DATADIR+sph+'_smoothed_spheroid_expanded_nonlocalmeansfiltered*.nrrd')
